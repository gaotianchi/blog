<script setup lang="ts">
	...
	import { ref, shallowRef, type Ref, watch, reactive } from "vue";
	...
	function submitDecision(decision: boolean): void {
		emits("confirm", decision);
		if (decision) {
			props.confirmProp.callback();
		}
	}
</script>
<template>
	<Teleport to="body">
		<Transition>
			<div class="parent-N1J4Cd-iJg" v-if="confirmProp.active">
...
<style scoped>
	...
	.parent-N1yLCdbike {
		background-color: rgba(240, 61, 61, 0.792);
	}
	.v-enter-from,
	.v-leave-to {
		opacity: 0;
	...
	.v-enter-from .v-container,
	.v-leave-to .v-container {
