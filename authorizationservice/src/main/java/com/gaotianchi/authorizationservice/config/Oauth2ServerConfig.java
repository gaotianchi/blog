...
public class Oauth2ServerConfig {
    ...
    @Autowired
    public Oauth2ServerConfig(RegisteredClientService registeredClientService) {
    ...
    public RegisteredClientRepository registeredClientRepository() {
        String clientId = "blog-client";
        RegisteredClient registeredClient;
        registeredClient = registeredClientService.findByClientId(clientId);
        if (registeredClient == null) {
            registeredClient = RegisteredClient.withId(UUID.randomUUID().toString())
                    ...
                    .redirectUri("http://127.0.0.1:8070/login/oauth2/code/blog")
                    .scope("read:user")
