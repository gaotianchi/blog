...
public class RegisteredClientService implements RegisteredClientRepository {
    ...
    private final RegisteredClientRepo registeredClientRepo;

    @Autowired
    public RegisteredClientService(RegisteredClientRepo registeredClientRepo) {
        Assert.notNull(registeredClientRepo, "clientRepository cannot be null");
    ...
    public void save(RegisteredClient registeredClient) {
        ...
        this.registeredClientRepo.save(toEntity(registeredClient));
    }
    ...
    public RegisteredClient findById(String id) {
        ...
        return this.registeredClientRepo.findById(id).map(this::toObject).orElse(null);
    }

    @Override
    public RegisteredClient findByClientId(String clientId) {
        Assert.hasText(clientId, "clientId cannot be empty");
        return this.registeredClientRepo.findByClientId(clientId).map(this::toObject).orElse(null);
    }
